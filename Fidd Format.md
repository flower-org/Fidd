...
По этой причине мы также планируем разработать собственную многоуровневую модель сервисного API, в которой самая первая и базовая (а потому и самая безопасная) модель не будет иметь функций получения данных с оффсета, а только скачивание полность всего файла.  
